...
/**
 * monty - the helper function for main function
 * @args: the pointer to struct of arguments from main
 * Description: this opens and reads from the file
 */
...
/**
 * main - the entry point for monty bytecode interpreter
